...
const Home = () => {
    ...
    const [ language, setLanguage ] = useState('US English (en-US)');
    ...
    return (
        <>
            ...
            <Grid container component="main" className={classNames(classes.main)}>
                ...
                <Grid item xs={12} id="error" class="isa_error"></Grid>
                <Grid item container component="form" xs={12} className={classNames(classes.form)}>
                    <TextField fullWidth label="Access ID" variant="outlined" className={classNames(classes.formInputContainer)} />
                    <TextField fullWidth label="Secret Key" variant="outlined" className={classNames(classes.formInputContainer)} />
                    <TextField 
                        fullWidth 
                    ...
                    <ButtonGroup color="primary" className={classNames(classes.formButtonsGroup)}>
                        <Button className={classNames(classes.formButton)}>
                            <i className={classNames('fa fa-microphone', classes.fa)}></i> Start
                        </Button>
                        <Button className={classNames(classes.formButton)}>
                            <i className={classNames('fa fa-stop-circle', classes.fa)}></i> Stop
                        </Button>
                        <Button className={classNames(classes.formButton)}>Clear Transcript</Button>
                    </ButtonGroup>
                </Grid>
                <Grid xs={12} className="col">
